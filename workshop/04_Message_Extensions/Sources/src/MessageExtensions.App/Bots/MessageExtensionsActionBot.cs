using MessageExtensions.App.Helpers;
...
namespace MessageExtensions.App.Bots;

public class MessageExtensionsActionBot : TeamsActivityHandler
{
	public readonly string BaseUrl;

	public MessageExtensionsActionBot(IConfiguration configuration) : base()
	{
	...
	private static MessagingExtensionActionResponse RazorViewResponse(ITurnContext<IInvokeActivity> turnContext, 
